...
var questions = [
    ...
    },
    {
      ...
      name: "account",
      message:
        "What is your account ID? [empty will default to the value at process.env.ACCOUNT_ID]\n"
    },
    {
      type: "password",
      name: "key",
    ...
    },
    {
      type: "list",
      name: "topic",
      message: "Create new topic or connect to an existing one",
